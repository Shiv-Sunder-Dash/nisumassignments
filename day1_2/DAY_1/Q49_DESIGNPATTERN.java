...
public class Q49_DESIGNPATTERN {
    ...
    static class RedColor implements Color { public void applyColor() { System.out.println("Applying red color"); } }
    static class BlueColor implements Color { public void applyColor() { System.out.println("Applying blue color"); } }
    abstract static class ColoredShape {
        protected Color color;
        public ColoredShape(Color color) { this.color = color; }
        abstract void draw();
    }
    static class Circle extends ColoredShape {
        public Circle(Color color) { super(color); }
        public void draw() { System.out.print("Circle filled with color: "); color.applyColor(); }
    }
    ...
    static class Leaf implements Component {
        ...
        public void display(int depth) { System.out.println("-".repeat(depth) + name); }
    }
    ...
    static class SimpleCircle implements Shape { public void draw() { System.out.println("Shape: Circle"); } }
    ...
    static class RedShapeDecorator extends ShapeDecorator {
        ...
        public void draw() { decoratedShape.draw(); setRedBorder(); }
        private void setRedBorder() { System.out.println("Border Color: Red"); }
    }

    static class CPU { public void start() { System.out.println("CPU started"); } }
    static class Memory { public void load() { System.out.println("Memory loaded"); } }
    static class HardDrive { public void read() { System.out.println("Hard drive read"); } }
    static class ComputerFacade {
        private CPU cpu = new CPU();
        private Memory memory = new Memory();
        private HardDrive hardDrive = new HardDrive();
        public void start() {
            cpu.start(); memory.load(); hardDrive.read();
